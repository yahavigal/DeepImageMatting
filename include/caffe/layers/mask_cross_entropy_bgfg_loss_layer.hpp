...
class MaskCrossEntropyBGFGLossLayer : public LossLayer<Dtype> {
public:
    explicit MaskCrossEntropyBGFGLossLayer(const LayerParameter& param);

    virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,const vector<Blob<Dtype>*>& top);

    virtual inline int ExactNumBottomBlobs() const { return 3; }
    virtual inline const char* type() const { return "MaskCrossEntropyBGFGLoss"; }
