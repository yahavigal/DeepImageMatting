...
namespace caffe {
	...
	*/
	...
	class MaskConnectAccuracyLayer : public Layer<Dtype> {
	public:
		/**
		...
		*/
		explicit MaskConnectAccuracyLayer(const LayerParameter& param);
		...
		virtual inline const char* type() const { return "MaskConnectAccuracy"; }
		...
		virtual inline int MaxTopBlos() const { return 1; }
                Dtype calc_connectivity(const cv::Mat& mask);
