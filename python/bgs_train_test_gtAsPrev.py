...
# Alexandra for temporal smoothing
        net.blobs[net.inputs[2]].reshape(*masks_prev.shape)
        net.blobs[net.inputs[3]].reshape(*masks_prev.shape)
        net.blobs[net.inputs[2]].data[...]= masks_prev
        # net.blobs[net.inputs[3]].data[...]= masks_prev
    ...
    def test(self, is_save_fig = True):
        ...
        while self.data_provider.epoch_ind == 0:
            img_r, mask_r, mask_prev_r, preds_prev_r = self.data_provider.get_test_data()
...
# Alexandra for temporal smoothing
            ...
            net.blobs[net.inputs[3]].reshape(*preds_prev_r.shape)
            net.blobs[net.inputs[2]].data[...]= mask_prev_r
            #net.blobs[net.inputs[3]].data[...]= mask_prev_r
            net.blobs[net.inputs[3]].data[...]= preds_prev_r
